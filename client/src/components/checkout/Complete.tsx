  ...
  return (
    <div id="payment-status">
      <div
        id="status-icon"
        style={{
          backgroundColor: STATUS_CONTENT_MAP[status as StatusType].iconColor,
        }}
      >
        {STATUS_CONTENT_MAP[status as StatusType].icon}
      </div>
      <h2 id="status-text">{STATUS_CONTENT_MAP[status as StatusType].text}</h2>
      {intentId && (
